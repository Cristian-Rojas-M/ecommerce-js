...
function orderEmail (obj) {
    let { idUser, email, username, order, total, adress } = obj;
    ...
    modelEmail = modelEmail.replace("%orderLink%", `<a href="http://localhost:3000/user/${idUser}" style="color: rgb(255, 104, 104);font-size: 1.5rem;">Link</a>`)
